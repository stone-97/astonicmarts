...
import { ProductdetailsComponent } from '../../../../shops/productdetails/productdetails.component';
...
export class ElectricpressurewashersComponent {
   products: Product[] = [];
         ...
         ngOnInit() {
           this.products = this.SearchService.getProductsByCategory('electric-pressure-washer');
         }
