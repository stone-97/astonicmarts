...
@Component({
  selector: 'app-selfpropelledlawnmower',
  templateUrl: './selfpropelledlawnmower.component.html',
  styleUrl: './selfpropelledlawnmower.component.css'
})
export class SelfpropelledlawnmowerComponent {
