...
@Component({
  selector: 'app-waterseperators',
  templateUrl: './waterseperators.component.html',
  styleUrl: './waterseperators.component.css'
})
export class WaterseperatorsComponent {
    ...
    ngOnInit() {
      this.products = this.SearchService.getProductsByCategory('water-seperators');
    }
    ...
    measuringTestingCategories: Category[] = [
      {
        ...
        items: [
          ...
          { name: 'Testing Paste', link: '/testingpaste' },
          { name: 'Measuring Cylinders', link: '/measuringcylinders' },
          { name: 'Flow Meter', link: '/fuelandflowmeters' },
          { name: 'Thermometers', link: '/thermometers' },
          { name: 'Fuel Testing Kits', link: '/fuel testing kits' },
